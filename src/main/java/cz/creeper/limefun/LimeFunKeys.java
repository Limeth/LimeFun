...
public class LimeFunKeys {
    ...
    // Watering Can
    public static final Key<Value<Integer>> WATERING_CAN_USES_LEFT = KeyFactory.makeSingleKey(new TypeToken<Integer>() {}, new TypeToken<Value<Integer>>() {}, DataQuery.of("WateringCanUsesLeft"), "limefun:watering_can_uses_left", "Uses left");
}
